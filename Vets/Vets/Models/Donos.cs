...
namespace Vets.Models
{
    public class Donos
    {
        ...
        [RegularExpression("[A-ZÓÂÍ][a-zçáéíóúàèìòùäëïöüâêîôûñ]+(( | d[ao](s)? | e |-|'| d')[A-ZÓÂÍ][a-zçáéíóúàèìòùäëïöüâêîôûñ]+){1,3}", ErrorMessage = "Deve escrever entre 2 e 4 nomes, começados por uma Maiúscula, seguidos de minúsculas")]
